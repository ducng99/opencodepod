    ...
    return (
        <div className="card-glow p-5 flex flex-col gap-4">
            ...
            <div className="space-y-2 text-sm">
                <div className="grid grid-cols-[auto_1fr] gap-x-2 gap-y-2 items-start text-oc-text-secondary">
                    {sshCmd && (
                        <>
                            <span className="text-xs font-semibold uppercase tracking-wider text-oc-text-muted self-center">SSH</span>
                            <div className="flex items-center gap-1.5 min-w-0">
                                <code className="code-block break-all flex-1" title={sshCmd}>{sshCmd}</code>
                                <button
                                    onClick={() => copyText(sshCmd, "ssh")}
                    ...
                    {webUrl && (
                        <>
                            <span className="text-xs font-semibold uppercase tracking-wider text-oc-text-muted self-center">Web</span>
                            <a
                                href={webUrl}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="code-block break-all text-oc-accent hover:text-oc-accent-hover transition-colors"
                            >
                                {webUrl}
                            </a>
                        </>
                    ...
                    {attachCmd && (
                        <>
                            <span className="text-xs font-semibold uppercase tracking-wider text-oc-text-muted self-center">Attach</span>
                            <div className="flex items-center gap-1.5 min-w-0">
                                <code className="code-block break-all flex-1" title={attachCmd}>{attachCmd}</code>
                                <button
                                    onClick={() => copyText(attachCmd, "attach")}
                                    className="btn-icon-subtle"
